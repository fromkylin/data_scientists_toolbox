...
def plot_horizontal_bars(sql_query:str,fig_name:str,sub_title:str,shareyaxis:bool=False):
    ...
    fig.suptitle(f'{sub_title}', fontsize=16)
    plt.tight_layout()
...
SELECT surveyed_in,
 ...
 ORDER BY surveyed_in,
          response_count;
"""
plot_horizontal_bars(sql_query,'data_science_job_titles','Data Science Job Titles by Year(2020-2022)')
...
SELECT surveyed_in,
 ...
 ORDER BY surveyed_in,
          response_count;
"""
plot_horizontal_bars(sql_query,'data_science_job_tasks','Data Science Job Tasks by Year(2020-2022)',shareyaxis=True)
...
SELECT surveyed_in,
 ...
 ORDER BY surveyed_in,
          response_count;
"""
plot_horizontal_bars(sql_query,'data_science_job_programming_languages','Data Science Job Programming Languages by Year(2020-2022)')
...
SELECT surveyed_in,
 ...
 ORDER BY surveyed_in,
          response_count;
"""
plot_horizontal_bars(sql_query,'data_science_job_databases','Data Science Job Databases by Year(2020-2022)')
...
SELECT surveyed_in,
 ...
 ORDER BY surveyed_in,
          response_count;
"""
plot_horizontal_bars(sql_query,'data_science_job_visualizations','Data Science Job Visualizations by Year(2020-2022)')
...
SELECT surveyed_in,
 ...
 ORDER BY surveyed_in,
          response_count;
"""
plot_horizontal_bars(sql_query,'data_science_job_machine_learnings','Data Science Job Machine Learnings by Year(2020-2022)')